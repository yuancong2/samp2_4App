...
public:
    ...
    void setupUi(QMainWindow *QWMainWind)
    {
        ...
        QIcon icon11(QIcon::fromTheme(QIcon::ThemeIcon::HelpAbout));
...
#if QT_CONFIG(tooltip)
        actionAbout->setToolTip(QCoreApplication::translate("QWMainWind", "information", nullptr));
#endif // QT_CONFIG(tooltip)
        actionabout->setText(QCoreApplication::translate("QWMainWind", "about", nullptr));
